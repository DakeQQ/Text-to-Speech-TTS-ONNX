...
for target_idx, target in enumerate(target_tts):
    ...
    if STREAMING:
        # Per-sentence streaming state: sliding window of 3 frames + async decoder futures.
    ...
    while num_decode_Main < generate_limit:
        ...
        if STREAMING:
            # Maintain a sliding window of the last 3 codec frame OrtValues (each (1, 16)).
    ...
    if STREAMING:
        ...
        if _stream_results:
            ...
            # Fewer than 3 frames generated; fall back to the non-streaming decoder.
