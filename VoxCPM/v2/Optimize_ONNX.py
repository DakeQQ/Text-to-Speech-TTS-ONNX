...
# Path Setting
original_folder_path = r"/home/DakeQQ/Downloads/VoxCPM_ONNX"                    # The original folder.
quanted_folder_path = r"/home/DakeQQ/Downloads/VoxCPM_Optimized"                # The optimized folder.
...
model_names = [                         # Recommended quantize dtype. The int8 is best for CPU.
    "VoxCPM2_AudioVAE_Encode",          # [float32, float16]
    "VoxCPM2_Feat_Encoder_Cond",        # [int8, float32, float16]
    "VoxCPM2_Assemble_VoiceDesign",     # [float32, float16]
    "VoxCPM2_Assemble_Continuation",    # [float32, float16]
    "VoxCPM2_Assemble_ReferenceOnly",   # [float32, float16]
    "VoxCPM2_Assemble_Combined",        # [float32, float16]
    "VoxCPM2_Prefill",                  # [int4, int8, float32, float16]
    "VoxCPM2_Rotary_Mask_Decode",       # [float32, float16]
    "VoxCPM2_Main",                     # [int4, int8, float32, float16]
    "VoxCPM2_Feat_Decoder",             # [float32, int8, float16]
    "VoxCPM2_AudioVAE_Decode",          # [float32, float16]
    "VoxCPM2_Concat",                   # [float32, float16] (streaming only)
]
...
if lazy_setting_CPU:
    if use_openvino:
        CPU_MODEL_DTYPE = {
            "VoxCPM2_AudioVAE_Encode":          "float32",
            "VoxCPM2_Feat_Encoder_Cond":        "float32",
            "VoxCPM2_Assemble_VoiceDesign":     "float32",
            "VoxCPM2_Assemble_Continuation":    "float32",
            "VoxCPM2_Assemble_ReferenceOnly":   "float32",
            "VoxCPM2_Assemble_Combined":        "float32",
            "VoxCPM2_Prefill":                  "int4",
            "VoxCPM2_Rotary_Mask_Decode":       "float32",
            "VoxCPM2_Main":                     "int4",
            "VoxCPM2_Feat_Decoder":             "float32",  # int8 can also work, but it will affect the quality.
            "VoxCPM2_AudioVAE_Decode":          "float32",
            "VoxCPM2_Concat":                   "float32",
        }
    else:
        CPU_MODEL_DTYPE = {
            "VoxCPM2_AudioVAE_Encode":          "float32",
            "VoxCPM2_Feat_Encoder_Cond":        "int8",
            "VoxCPM2_Assemble_VoiceDesign":     "float32",
            "VoxCPM2_Assemble_Continuation":    "float32",
            "VoxCPM2_Assemble_ReferenceOnly":   "float32",
            "VoxCPM2_Assemble_Combined":        "float32",
            ...
            "VoxCPM2_Rotary_Mask_Decode":       "float32",
            "VoxCPM2_Main":                     "int4",
            "VoxCPM2_Feat_Decoder":             "int8",     # int8 = speed / float32 = quality.
            "VoxCPM2_AudioVAE_Decode":          "float32",
            "VoxCPM2_Concat":                   "float32",
        }
elif lazy_setting_GPU:
    GPU_MODEL_DTYPE = {
        "VoxCPM2_AudioVAE_Encode":          "float16",
        "VoxCPM2_Feat_Encoder_Cond":        "float16",
        "VoxCPM2_Assemble_VoiceDesign":     "float16",
        "VoxCPM2_Assemble_Continuation":    "float16",
        "VoxCPM2_Assemble_ReferenceOnly":   "float16",
        "VoxCPM2_Assemble_Combined":        "float16",
        "VoxCPM2_Prefill":                  "float16",
        "VoxCPM2_Rotary_Mask_Decode":       "float16",
        "VoxCPM2_Main":                     "float16",
        "VoxCPM2_Feat_Decoder":             "float16",
        "VoxCPM2_AudioVAE_Decode":          "float16",
        "VoxCPM2_Concat":                   "float16",
    }
...
for model_name in model_names:
    ...
    if "Main" in model_path:
        hidden_size = 2048
    elif "Encode" in model_path or "Decode" in model_path:
        hidden_size = 1024
    else:
        hidden_size = 0
    ...
    if quant_int4 and ("Prefill" in model_path or "Main" in model_path or "Encoder" in model_path or "Decoder" in model_path):
        block_size = 16 if lazy_setting_CPU or lazy_setting_GPU else block_size
        ...
        if use_nbits_for_int8:
            ...
            block_size = 32 if lazy_setting_CPU or lazy_setting_GPU else block_size
        ...
        model = optimize_model(
            model_path,
            use_gpu=False,
            opt_level=1 if (use_openvino or "VAE_Decode" in model_path) else 2,
            num_heads=16 if ("Main" in model_path or "Encode" in model_path or "Decode" in model_path) else 0,
